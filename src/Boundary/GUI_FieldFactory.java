...
public final class GUI_FieldFactory {
    ...
    public static GUI_Field[] fieldInitializer() {
        ...
        fields[i] = new GUI_Start("Start", "Modtag: M2$", "Modtag 4000\nNår du passerer", Color.RED, Color.BLACK);
        fields[var2++] = new GUI_Street("Rødovrevej", "Pris:  1200", "", "Leje: 50", new Color(75, 155, 225), Color.BLACK);
        fields[var2++] = new GUI_Chance("?", "Chance", "Prøv lykken!", new Color(240,230,140), Color.BLACK);
        fields[var2++] = new GUI_Street("Hvidovrevej", "Pris: 1200", "", "Leje: 50", new Color(75, 155, 225), Color.BLACK);
        fields[var2++] = new GUI_Tax("Indkomstskat", "Betal 4000", "", new Color(135, 206, 250), Color.BLACK);
        fields[var2++] = new GUI_Street("Scandlines 1", "4000", "", "Leje: 500 for 1, 1000 for 2", new Color(255,105,180), Color.BLACK);
        ...
        fields[var2++] = new GUI_Brewery("default", "Tuborg Squash", "Pris:  3000", "", "100 x [Terningslag]", new Color(220,50,50), Color.WHITE);
        ...
        fields[var2++] = new GUI_Street("Molslinjen", "4000", "", "Leje: 500 for 1, 1000 for 2", new Color(255,105,180), Color.BLACK);
        ...
        fields[var2++] = new GUI_Street("Scandlines 2", "4000", "", "Leje: 500 for 1, 1000 for 2", new Color(255,105,180), Color.BLACK);
        ...
        fields[var2++] = new GUI_Brewery("default", "Coca Cola", "Pris:  3000", "", "100 x [Terningslag]", new Color(220,50,50), Color.WHITE);
        ...
        fields[var2++] = new GUI_Street("Scandlines 3", "4000", "", "Leje: 500 for 1, 1000 for 2", new Color(255,105,180), Color.BLACK);
        fields[var2++] = new GUI_Chance("?", "Chance", "Prøv lykken!", new Color(240,230,140), Color.BLACK);
