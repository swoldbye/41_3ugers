...
public class FieldList { //Information Expert Class
    ...
    public static Field_Abstract[] createFieldList() {
        ...
        fields[var2++] = new Field_Property(2,"Rødovrevej", 1200, 50,1,"",1000,2000,0,0);
        fields[var2++] = new Field_Chance(3, "Chance");
        fields[var2++] = new Field_Property(4,"Hvidovrevej", 1200, 50,1,"",1000,2000,0,0);
        fields[var2++] = new Field_Tax(5,"Skat 1",4000);
        fields[var2++] = new Field_Shipping(6,"Båd 1",4000,500,2, "");
        fields[var2++] = new Field_Property(7,"Roskildevej", 2000,150,3,"", 1000,2000,0,0);
        fields[var2++] = new Field_Chance(8, "Chance");
        fields[var2++] = new Field_Property(9,"Valby Langade", 2000,100,3,"", 1000,2000,0,0);
        fields[var2++] = new Field_Property(10,"Allégade",2400,150,3,"",1000,2000,0,0);
        fields[var2++] = new Field_Jail(11, "På besøg");
        fields[var2++] = new Field_Property(12,"Frederikberg allé",2800, 200, 4,"", 1000,2000,0,0);
        fields[var2++] = new Field_Soda(13,"Tuborg Squash", 3000,100, 5, "");
        fields[var2++] = new Field_Property(14,"Bülowsvej", 2800, 200, 4,"",1000,2000,0,0);
        fields[var2++] = new Field_Property(15, "Gl. Kongevej", 3200,250, 4,"",1000,2000,0,0);
        fields[var2++] = new Field_Shipping(16, "Båd 2", 4000, 500, 2, "");
        fields[var2++] = new Field_Property(17,"Bernstorffsvej",3600,300, 6,"",2000, 3000,0,0);
        ...
        fields[var2++] = new Field_Property(25,"Grønningnen",4800,400,7, "", 2000,3000,0,0);
        fields[var2++] = new Field_Shipping(26,"Båd 3", 4000, 500,2,"");
        fields[var2++] = new Field_Property(27,"Bredgade", 5200, 450, 8, "",2000,3000,0,0);
        fields[var2++] = new Field_Property(28,"Kgs. Nytorv", 5200, 450, 8, "",2000,3000,0,0);
        fields[var2++] = new Field_Soda(29,"Coca Cola",3000, 100,5, "");
